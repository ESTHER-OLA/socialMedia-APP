...
import waterside from "../../assets/images/waterside.jpg";
  ...
  return (
    <div className="flex flex-col h-screen bg-white shadow-lg border-2 rounded-l-xl">
      <div className="flex flex-col items-center relative pt-10">
        <img className="h-48 rounded-md" src={waterside} alt="nature"></img>
      </div>
      <p className="font-roboto font-normal text-sm text-gray-700 max-w-fit no-underline tracking-normal leading-tight py-2 mx-2">
        And when twilight descends, the stars emerge Diamonds strewn across the
        velvet expanse.Moonlight bathes the world, casting shadows soft, As
        crickets serenade the night, their song eternal.Oh, Mother Nature, your
        beauty knows no bounds From dewdrop to mountain peak, you enchant our
        souls."
      </p>
