    ...
    <div className="flex flex-col h-screen bg-white pb-4 border-2 rounded-r-xl shadow-lg">
      ...
      <div className="flex flex-col pl-2">
        <div className="flex items-center pb-4">
          ...
          <p className="font-roboto font-bold text-sm no-underline tracking-normal leading-none">
            California
          </p>
        </div>
      ...
      <div className="ml-2">
        ...
        <div className="flex items-center">
          <img className="h-5 mb-3 mr-2" src={facebook} alt="facebook"></img>
          <p className="font-roboto font-bold text-lg text-[#b70101] no-underline tracking-normal leading-none py-2">
            Social Network
          </p>
        </div>

        <div className="flex items-center">
          <img className="h-5 mb-3 mr-2" src={twitter} alt="twitter"></img>
          <p className="font-roboto font-bold text-lg text-[#b70101] no-underline tracking-normal leading-none py-2">
            Social Network
          </p>
        </div>
