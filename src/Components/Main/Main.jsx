...
import Feeling from "../../assets/images/smile.png";
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex flex-col py-4 w-full bg-white rounded-3xl shadow-lg">
            ...
            <div className="flex justify-between items-center">
              <div className="w-full ml-4">
                <input
                  type="text"
                  name="text"
                  //making the placeholder to reflect user name
              ...
              {/* displaying how image will reflect when uploading/sharing image */}
              <div className="mx-4">
                {image && (
                  <img
        ...
        <span
          //image progress bar when uploading
        ...
        <div className="flex justify-around items-center pt-4">
          <div className="flex items-center">
            ...
            >
              ...
              ></input>
              {/* making our image on click to upload file */}
            </label>
            {file && (
          ...
          <div className="flex items-center">
            <img className="h-10 mr-4" src={Feeling} alt="smile"></img>
            <p className="font-roboto font-medium text-md text-gray-700 no-underline tracking-normal leading-none">
              Feeling
            </p>
          </div>
